...
import IssueAsset from '../tx/special_tx/issue_asset_tx'
import TransferAsset from '../tx/special_tx/transfer_asset_tx'
import ReplenishAsset from '../tx/special_tx/replenish_asset_tx'
import ModifyAsset from  '../tx/special_tx/modify_asset_tx'
...
const apis = {
    ...
    signIssueAsset(privateKey, txConfig, issueAssetInfo) {
        txConfig = checkChainID(txConfig, this.chainID)
        const tx = new IssueAsset(txConfig, issueAssetInfo)
        tx.signWith(privateKey)
        return JSON.stringify(tx.toJson())
    },
    /**
    ...
    signTransferAsset(privateKey, txConfig, transferAssetInfo) {
        txConfig = checkChainID(txConfig, this.chainID)
        const tx = new TransferAsset(txConfig, transferAssetInfo)
        tx.signWith(privateKey)
        return JSON.stringify(tx.toJson())
    },
    /**
    ...
    signReplenishAsset(privateKey, txConfig, replenishInfo) {
        txConfig = checkChainID(txConfig, this.chainID)
        const tx = new ReplenishAsset(txConfig, replenishInfo)
        tx.signWith(privateKey)
        return JSON.stringify(tx.toJson())
    },
    /**
    ...
    signModifyAsset(privateKey, txConfig, modifyInfo) {
        txConfig = checkChainID(txConfig, this.chainID)
        const tx = new ModifyAsset(txConfig, modifyInfo)
        tx.signWith(privateKey)
        return JSON.stringify(tx.toJson())
    },
    /**
