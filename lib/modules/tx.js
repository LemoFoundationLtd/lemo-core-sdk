...
import TradingAsset from '../tx/special_tx/trading_asset_tx'
...
const apis = {
     ...
     * @return {string}
     */
    signTradingAsset(privateKey, txConfig, tradingAssetInfo) {
        txConfig = checkChainID(txConfig, this.chainID)
        const tx = new TradingAsset(txConfig, tradingAssetInfo)
        tx.signWith(privateKey)
        return JSON.stringify(tx.toJson())
    },
    /**
