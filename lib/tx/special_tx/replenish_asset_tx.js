...
export default class ReplenishAsset extends Tx {
    /**
     * 增发资产的交易
     ...
     * @param {string} replenishInfo.assetId 增发的资产ID
     * @param {boolean} replenishInfo.isReplenishable 是否可增发
     * @param {string} replenishInfo.assetCode 增发的资产code
     * @param {string} replenishInfo.ReplenishAmount 增发的数量
     */
    constructor(txConfig, replenishInfo) {
        ...
        const newReplenishAsset = {
            ...
            isReplenishable: replenishInfo.isReplenishable,
