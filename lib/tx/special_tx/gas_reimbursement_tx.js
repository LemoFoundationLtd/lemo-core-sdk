...
export default class ReimbursementTx extends Tx {
     ...
     * @param {string?} noGasTx.from The transaction send address
     ...
     * @param {Array?} noGasTx.sigs Signature data
    ...
    signGasWith(privateKey) {
        this.gasPayerSigs.push(new GasSinger().signGas(this, privateKey))
    }
}
