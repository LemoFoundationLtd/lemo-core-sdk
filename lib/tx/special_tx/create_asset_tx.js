...
export default class CreateAssetTx extends Tx {
    ...
    constructor(txConfig, createAssetInfo) {
        ...
        const newCreateAsset = {
            category: createAssetInfo.category === undefined ? CreateAssetType.type1 : createAssetInfo.category,
            decimals: createAssetInfo.decimals === undefined ? 18 : createAssetInfo.decimals,
            isReplenishable: createAssetInfo.isReplenishable || true,
            isDivisible: createAssetInfo.isDivisible || true,
            profile: {
