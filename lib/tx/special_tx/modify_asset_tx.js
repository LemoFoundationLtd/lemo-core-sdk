...
export default class modifyAsset extends Tx {
    /**
     * 修改资产的交易
    ...
    constructor(txConfig, modifyInfo) {
        ...
        const newModifyAsset = {
            ...
            info: {
                ...
                symbol: modifyInfo.info.symbol.toUpperCase(),
                description: modifyInfo.info.description,
                suggestedGasLimit: modifyInfo.info.suggestedGasLimit || '60000',
                stop: 'false',
            },
        }
        ...
        delete newModifyAsset.to
        delete newTxConfig.amount
        delete newModifyAsset.toName
        super(newTxConfig)
    }
}
