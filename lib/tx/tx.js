...
export default class Tx {
    ...
    toJson() {
        ...
        setIfExist(result, 'gasPrice', this.gasPrice.toString(10))
        setIfExist(result, 'gasLimit', this.gasLimit.toString(10))
        setIfExist(result, 'amount', this.amount.toString(10))
        setIfExist(result, 'data', this.data)
        setIfExist(result, 'expirationTime', this.expirationTime.toString(10))
