...
var uncleCall = function (args) {
    return (utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'lemo_getUncleByBlockHashAndIndex' : 'lemo_getUncleByBlockNumberAndIndex';
};
...
var uncleCountCall = function (args) {
    return (utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'lemo_getUncleCountByBlockHash' : 'lemo_getUncleCountByBlockNumber';
};
