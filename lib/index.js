...
function exposeStaticProperties(lemo) {
    ...
    LemoCore.TxType = LemoTx.TxType
    LemoCore.ChangeLogType = ChangeLogType

    lemo.SDK_VERSION = LemoCore.SDK_VERSION
    lemo.BigNumber = LemoCore.BigNumber
    lemo.TxType = LemoCore.TxType
