export default {
    ...
    TXFromCanNotEmpty: () => 'The from field cannot be empty',
    ...
    TXInvalidUserIdLength: () => 'The length of the userid cannot be less than 10',
    WeightNotReach: () => 'The weight does not reach 100',
}
