...
[lemo.tx.send(txConfig, privateKey)](#submodule-tx-send) | 发送交易 | ✓ | ✓
...
##### Parameters
1. `number` - [watchTx](#submodule-tx-watchTx)或[watchPendingTx](#submodule-tx-watchPendingTx)返回的subscribeId
