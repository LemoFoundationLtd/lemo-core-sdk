...
describe('CreateAssetTx_new', () => {
    ...
    const tests = [
        ...
        {field: 'category', configData: 2},
        {field: 'category', configData: 3},
        {field: 'category', configData: 0, error: 'category can not be 0'},
        {field: 'category', configData: '1', error: errors.TXInvalidType('category', '1', ['number'])},
        {field: 'category', configData: '0xxx', error: errors.TXInvalidType('category', '1', ['number'])},
        {field: 'decimals', configData: 18},
        {field: 'decimals', configData: 0},
        {field: 'decimals', configData: '0xxx', error: errors.TXInvalidType('decimals', '1', ['number'])},
