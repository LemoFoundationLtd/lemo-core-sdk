...
const pubKey = '0x045e3600755f9b512a65603b38e30885c98cbac70259c3235c9b3f42ee563b480edea351ba0ff5748a638fe0aeff5d845bf37a3b437831871b48fd32f33cd9a3c0'
...
describe('crypto_recover', () => {
    it('recover', () => {
        testTxs.forEach(test => {
            ...
            const result = recover(toBuffer(test.hash), signdResult.recovery, signdResult.r, signdResult.s)
            assert.exists(result)
            assert.strictEqual(`0x${result.toString('hex')}`, pubKey)
        })
    })
})
